                ...
                <tr>
                    ...
                    <div class="row">
                        <div id="<?php echo $survey->id ?>" class="collapse">
                            ...
                            <li><label  style="font-weight: bold ; width: 60%; display:inline-block">Initiated:</label> {{$survey->initiated}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Total Matriculants:</label> {{$survey->totalmatriculants}}</li>
                            <li><label  style="font-weight: bold ; width: 60%; display:inline-block">Med School Terms:</label> {{$survey->medschoolterms}}</li>
                            <li><label  style="font-weight: bold ; width: 60%; display:inline-block">Aiding Schools:</label>{{$survey->aidingschools}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Total Per Year:</label>{{$survey->totalperyear}}</li>

                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Faculty:</label>{{$survey->faculty}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">App. Process:</label>{{$survey->appprocess}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Program Elements:</label>{{$survey->programelements}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Financial Support:</label>{{$survey->finsupport}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Faculty Time:</label>{{$survey->facultytimeallotted}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Admin Support:</label>{{$survey->adminsupport}}</li>
                            <li><label style="font-weight: bold ; width: 60%; display:inline-block">Contact Info:</label>{{$survey->contactinfo}}</li>
